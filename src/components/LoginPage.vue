...
const { setJWT, maintainer, loggedIn } = userUserStore();
...
<template>
  <div class="w-full h-full flex items-center justify-center">
    ...
    >
      ...
      <div v-if="requestComplete && loggedIn" class="flex flex-row items-center gap-2">
        <span class="text-lg text-slate-200">登录成功</span>
